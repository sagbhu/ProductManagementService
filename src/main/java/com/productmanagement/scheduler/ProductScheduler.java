 ...
 * 
 * import com.productmanagement.constant.ProductServiceConstants; import
 * com.productmanagement.service.ProductCategoryService; import
 * com.productmanagement.service.ProductService;
 * 
 * @Component public class ProductScheduler {
 * 
 * private static final Logger logger =
 * LoggerFactory.getLogger(ProductScheduler.class);
 * 
 * @Autowired ProductService productService;
 * 
 * @Autowired ProductCategoryService productCategoryService;
 * 
 * @Scheduled(cron = ProductServiceConstants.PRODUCT_CRON) public void
 * syncProductsWithVinculum() {
 ...
 * 
 * @Scheduled(cron = ProductServiceConstants.PRODUCT_CATEGORY_CRON) public void
 * syncProductsCategoriesWithVinculum() {
